        ...
        function(e) {
            ...
            function l(e) {
                ...
                if (e) s.$wrapperEl.find(`.${s.params.slideClass}`).remove();
                    ...
                    for (let e = d; e <= c; e += 1)(e < w || e > b) && s.$wrapperEl.find(`.${s.params.slideClass}[bwdads-data-swiper-slide-index="${e}"]`).remove();
        ...
        function(e) {
            ...
            function p() {
                ...
                if (((t.params.navigation = F(t, t.originalParams.navigation, t.params.navigation, {
                        nextEl: "bwdads-swiper-button-next",
                        prevEl: "bwdads-swiper-button-prev"
        ...
        function(e) {
            ...
            s({
                zoom: {
                    ...
                    minRatio: 1,
                    toggle: !0,
                    containerClass: "bwdads-swiper-zoom-container",
                    zoomedSlideClass: "bwdads-swiper-slide-zoomed"
                }
            }), (t.zoom = {
                enabled: !1
            });
        ...
        function(e) {
            ...
            s({
                thumbs: {
                    ...
                    autoScrollOffset: 0,
                    slideThumbActiveClass: "bwdads-swiper-slide-thumb-active",
                    thumbsContainerClass: "bwdads-swiper-thumbs"
                }
            });
            let i = !1,
                r = !1;
        ...
        function(e) {
            ...
            te({
                ...
                setTranslate: () => {
                    ...
                    p.shadow &&
                        (u ?
                            ((m = s.find(".bwdads-swiper-cube-shadow")), 0 === m.length && ((m = d('<div class="bwdads-swiper-cube-shadow"></div>')), s.append(m)), m.css({
                                height: `${r}px`
                            })) :
        ...
        function(e) {
            ...
            te({
                ...
                setTransition: (e) => {
                    ...
                    (s ? t.slides.find(s) : t.slides).transition(e).find(".bwdads-swiper-slide-shadow").transition(e), ae({
                        swiper: t,
                        duration: e,
                        transformEl: s,
                        allSlides: !0
