    ...
    var i = function(t) {
        ...
        if (window.performance) {
                ...
                for (var b = 0; b < r.length; b++) {
                    ...
                    if (M) {
                        ...
                        if ("js" === M) {
                            ...
                            u += E.duration;
                            a += 1
                        } else if ("gif" === M || "jpg" === M || "jpeg" === M || "png" === M) {
                            l += E.duration;
                            d += 1
                        } else if ("woff" === M || "woff2" === M || "ttf" === M || "otf" === M) {
                            m += E.duration;
                            c += 1
                        } else {
                            v += E.duration;
            ...
            for (var b = 0; b < T.length; b++) {
                var k = T[b];
                if ("first-paint" === k.name) {
                    t.first_paint = Math.round(k.startTime)
                } else if ("first-contentful-paint" === k.name) {
                    t.first_cf_paint = Math.round(k.startTime)
                }
            }
        }
    };
